...
var Dashboard = function Dashboard() {
  ...
  }, "Forging Plan")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var WeeklyPlan = function WeeklyPlan() {
  ...
  }, "Weekly Plan View")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: "flex",
      gap: "10px"
    }
...
var WeeklyPlanDisplay = function WeeklyPlanDisplay() {
  ...
  var fetchWeeklyPlan = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response, data, latestUniqueData, latestPerDay, mappedData, grouped;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
          ...
          case 10:
            ...
            latestUniqueData = deduplicateLatest(data); // 🧠 Filter only latest per day first
            latestPerDay = filterLatestPerDay(data); // 👇 Then map and group
        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            if (results.length === 1) {
              item = results[0];
              setEditFormData(function (prev) {
                var shift1 = prev.shift1_qty || 0;
                var shift2 = prev.shift2_qty || 0;
                var shift3 = prev.shift3_qty || 0;
                var netWt = item.net_wt || 0;
  ...
  var editableFields = ["die_no", "forge_press", "netWt", "customer", "prod_tonn", "prod_order", "section", "rm_grade", "die_req", "rm_status", "heat_code", "remark", "shift1_qty", "shift2_qty", "shift3_qty"];
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "weekly-plan-container"
  }, validationErrors.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
//# sourceMappingURL=kalyani-iot-ppc-forging.dev.e69c3ba20fec5616e478.js.map